...
public class Player implements flip.sim.Player
{
	...
	public List<Pair<Integer, Point>> getMoves(Integer num_moves, HashMap<Integer, Point> player_pieces, HashMap<Integer, Point> opponent_pieces, boolean isplayer1) {
		...
		for(int i = 0; i < num_moves; i++) {			
			...
			Aggressive aggressive = new Aggressive(duplicate_player_pieces, opponent_pieces, isplayer1, n, diameter_piece);
			ObstacleAvoidance obstacleAvoidance = new ObstacleAvoidance(duplicate_player_pieces, opponent_pieces, isplayer1, n, diameter_piece);
			ObstacleCreation obstacleCreation = new ObstacleCreation(duplicate_player_pieces, opponent_pieces, isplayer1, n, diameter_piece);
